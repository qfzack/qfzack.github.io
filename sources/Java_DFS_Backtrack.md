...
Mar 9, 2020[Algorithm](/categories/Algorithm)
...
# 1.组合总数问题[](2020/03/09/Java_DFS_Backtrack#1-组合总数问题)

## NO.39 组合总数[](2020/03/09/Java_DFS_Backtrack#NO-39-组合总数)
...
## NO.40 组合总数II[](2020/03/09/Java_DFS_Backtrack#NO-40-组合总数II)
...
## NO.216 组合总数III[](2020/03/09/Java_DFS_Backtrack#NO-216-组合总数III)
...
## NO.377 组合总数IV[](2020/03/09/Java_DFS_Backtrack#NO-377-组合总数IV)
...
# 2.图的拓扑排序[](2020/03/09/Java_DFS_Backtrack#2-图的拓扑排序)

简单来说，图的拓扑排序就是在一个有向图中，对所有的节点进行排序，要求排列的顺序满足有向图中的指向，拓扑排序的结果一般不止一种；

## NO.210 课程表II[](2020/03/09/Java_DFS_Backtrack#NO-210-课程表II)
...
# 3.八皇后等问题[](2020/03/09/Java_DFS_Backtrack#3-八皇后等问题)

八皇后问题是一个标准的回溯求解的问题，每次在棋盘上放置一个皇后时需要考虑棋盘中其它皇后的位置，如果当前没有位置可以放置，则退回到上一步重新放置……与此类似的还有数独问题；

## NO.37 解数独[](2020/03/09/Java_DFS_Backtrack#NO-37-解数独)
...
## NO.51 N皇后[](2020/03/09/Java_DFS_Backtrack#NO-51-N皇后)
...
# 其他的DFS与回溯问题[](2020/03/09/Java_DFS_Backtrack#其他的DFS与回溯问题)
...
## NO.17 电话号码的字母组合[](2020/03/09/Java_DFS_Backtrack#NO-17-电话号码的字母组合)
...
## NO.78 子集[](2020/03/09/Java_DFS_Backtrack#NO-78-子集)
...
## NO.79 单词搜索[](2020/03/09/Java_DFS_Backtrack#NO-79-单词搜索)
...
## NO.93 复原IP地址[](2020/03/09/Java_DFS_Backtrack#NO-93-复原IP地址)
...
## NO.131 分割回文串[](2020/03/09/Java_DFS_Backtrack#NO-131-分割回文串)
...
## NO.200 岛屿数量[](2020/03/09/Java_DFS_Backtrack#NO-200-岛屿数量)
...
## NO.322 零钱兑换[](2020/03/09/Java_DFS_Backtrack#NO-322-零钱兑换)
...
## NO.337 打家劫舍III[](2020/03/09/Java_DFS_Backtrack#NO-337-打家劫舍III)
...
## NO.417 太平洋大西洋水流问题[](2020/03/09/Java_DFS_Backtrack#NO-417-太平洋大西洋水流问题)
...
## NO.473 火柴拼正方向[](2020/03/09/Java_DFS_Backtrack#NO-473-火柴拼正方向)
...
## NO.542 01矩阵[](2020/03/09/Java_DFS_Backtrack#NO-542-01矩阵)
...
## NO.547 朋友圈[](2020/03/09/Java_DFS_Backtrack#NO-547-朋友圈)
...
## NO.576 出界的路径数[](2020/03/09/Java_DFS_Backtrack#NO-576-出界的路径数)
...
## NO.695 岛屿的最大面积[](2020/03/09/Java_DFS_Backtrack#NO-695-岛屿的最大面积)
...
## NO.5406
收集树上所有苹果的最少时间[](2020/03/09/Java_DFS_Backtrack#NO-5406-收集树上所有苹果的最少时间)
...
![](/2020/03/09/Java_DFS_Backtrack/NO5406.png)  
...
## NO.面试题17.22 单词转换[](2020/03/09/Java_DFS_Backtrack#NO-面试题17-22-单词转换)
