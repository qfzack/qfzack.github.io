...
Mar 9, 2020[Java](/categories/Java)

# 一、注解[](2020/03/09/Java_annotation#一、注解)

## 1.注解的概念：[](2020/03/09/Java_annotation#1-注解的概念：)

注解是Java提供的一种原程序中的元素关联任何信息和任何元数据的途径和方法。

## 2.Java中的常见注解[](2020/03/09/Java_annotation#2-Java中的常见注解)

### 2.1 JDK自带的注解：[](2020/03/09/Java_annotation#2-1-JDK自带的注解：)
...
## 3.注解的分类[](2020/03/09/Java_annotation#3-注解的分类)
...
## 4.自定义注解[](2020/03/09/Java_annotation#4-自定义注解)

### 4.1 自定义注解的语法要求：[](2020/03/09/Java_annotation#4-1-自定义注解的语法要求：)
...
### 4.2 自定义注解的使用：[](2020/03/09/Java_annotation#4-2-自定义注解的使用：)
...
### 4.3 注解的解析：[](2020/03/09/Java_annotation#4-3-注解的解析：)
...
# 二、反射[](2020/03/09/Java_annotation#二、反射)

## 1.Class类的使用[](2020/03/09/Java_annotation#1-Class类的使用)
...
## 2.方法的反射执行[](2020/03/09/Java_annotation#2-方法的反射执行)
...
## 3.动态类加载[](2020/03/09/Java_annotation#3-动态类加载)
...
## 4.通过反射认识泛型的本质[](2020/03/09/Java_annotation#4-通过反射认识泛型的本质)
...
[反射](/tags/%E5%8F%8D%E5%B0%84)[注解](/tags/%E6%B3%A8%E8%A7%A3)
