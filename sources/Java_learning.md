...
Nov 5, 2019[Java](/categories/Java)

# 1\. 对java中泛型的理解[](2019/11/05/Java_learning#1-对java中泛型的理解)
...
# 2\. Collections接口与Map接口[](2019/11/05/Java_learning#2-Collections接口与Map接口)
...
# 3\. Lambda表达式[](2019/11/05/Java_learning#3-Lambda表达式)
...
# 4\. HashMap与HashCode：[](2019/11/05/Java_learning#4-HashMap与HashCode：)
...
# 5\. 笔记碎片[](2019/11/05/Java_learning#5-笔记碎片)

## 001\. 列表List的常用方法：[](2019/11/05/Java_learning#001-列表List的常用方法：)
...
## 002\.
字符串String的基本方法与字符类型Char：[](2019/11/05/Java_learning#002-字符串String的基本方法与字符类型Char：)
...
## 003\. list排序与初始化：[](2019/11/05/Java_learning#003-list排序与初始化：)
...
## 004\. 关于二维数组与二维list：[](2019/11/05/Java_learning#004-关于二维数组与二维list：)
...
## 005\. 字符串与字符(数组)的转换[](2019/11/05/Java_learning#005-字符串与字符-数组-的转换)
...
## 006\. 自定义排序方法对list进行排序：[](2019/11/05/Java_learning#006-自定义排序方法对list进行排序：)
...
## 007\.
关于Java中list与int[]互转的坑：[](2019/11/05/Java_learning#007-关于Java中list与int-互转的坑：)
...
## 008\. Java中的栈与队列：[](2019/11/05/Java_learning#008-Java中的栈与队列：)

### 栈的实现与方法：[](2019/11/05/Java_learning#栈的实现与方法：)
...
### 队列的实现与方法：[](2019/11/05/Java_learning#队列的实现与方法：)
