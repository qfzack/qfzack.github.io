# ubuntu环境下配置远程访问jupyter notebook
...
![](/2019/10/11/ubuntu-jupyter/Image7.jpg)  
...
![](/2019/10/11/ubuntu-jupyter/Image8.jpg)  
如果想关闭服务：

  * `ps -ef`查看后台进程： ![](/2019/10/11/ubuntu-jupyter/Image9.jpg)
  * 找到jupyterlab对应的进程号，使用`kill -9 12765`关掉进程

**8.安装jupyterlab的扩展**  
先安装一个生成目录的插件`jupyter labextension install @jupyterlab/toc`，提示要先安装nodejs和npm：  
![](/2019/10/11/ubuntu-jupyter/Image10.jpg)  
...
list`查看已安装的插件：  
![](/2019/10/11/ubuntu-jupyter/Image11.jpg)

  * jupyterlab配置：<https://www.cnblogs.com/lskreno/p/10844315.html>

[jupyter notebook](/tags/jupyter%20notebook)[ubuntu](/tags/ubuntu)
