...
Dec 13, 2019[Algorithm](/categories/Algorithm)
...
# 1\. 多数和问题[](2019/12/13/Java_leetcode_note#1-多数和问题)
...
## NO.15 三数之和[](2019/12/13/Java_leetcode_note#NO-15-三数之和)
...
## NO.16 最接近的三数之和[](2019/12/13/Java_leetcode_note#NO-16-最接近的三数之和)
...
## NO.18 四数之和[](2019/12/13/Java_leetcode_note#NO-18-四数之和)
...
# 2\. 搜索旋转数组问题[](2019/12/13/Java_leetcode_note#2-搜索旋转数组问题)
...
## NO.33 搜索旋转排序数组[](2019/12/13/Java_leetcode_note#NO-33-搜索旋转排序数组)
...
## NO.81 搜索旋转排序数组II[](2019/12/13/Java_leetcode_note#NO-81-搜索旋转排序数组II)
...
## NO.153 寻找旋转排序数组中的最小值[](2019/12/13/Java_leetcode_note#NO-153-寻找旋转排序数组中的最小值)
...
## NO.154
寻找旋转排序数组中的最小值II[](2019/12/13/Java_leetcode_note#NO-154-寻找旋转排序数组中的最小值II)
...
# 3\. 丑数问题[](2019/12/13/Java_leetcode_note#3-丑数问题)

丑数的定义是只包含质因数2，3，5的正整数；

## NO.263 丑数[](2019/12/13/Java_leetcode_note#NO-263-丑数)
...
## NO.264 丑数II[](2019/12/13/Java_leetcode_note#NO-264-丑数II)
...
# 4\. 字符串问题[](2019/12/13/Java_leetcode_note#4-字符串问题)

字符串问题本来是一大类问题，和数组一样，但是目前做题遇到的方法不多，就暂时将字符串问题分为一类；

## NO.3 无重复字符的最长子串[](2019/12/13/Java_leetcode_note#NO-3-无重复字符的最长子串)
...
## NO.5 最长回文子串[](2019/12/13/Java_leetcode_note#NO-5-最长回文子串)
...
## NO.12 整数转罗马数字[](2019/12/13/Java_leetcode_note#NO-12-整数转罗马数字)
...
## NO.49 字母异位词分组[](2019/12/13/Java_leetcode_note#NO-49-字母异位词分组)
...
## NO.394 字符串解码[](2019/12/13/Java_leetcode_note#NO-394-字符串解码)
...
## NO.767 重构字符串[](2019/12/13/Java_leetcode_note#NO-767-重构字符串)
...
# 5\. 并查集[](2019/12/13/Java_leetcode_note#5-并查集)
...
## NO.684 冗余连接[](2019/12/13/Java_leetcode_note#NO-684-冗余连接)
...
![](/2019/12/13/Java_leetcode_note/NO684.png)  
最后将[1,5]连接上就是一棵树；
...
## NO.990 等式方程的可满足性[](2019/12/13/Java_leetcode_note#NO-990-等式方程的可满足性)
...
# 其他问题[](2019/12/13/Java_leetcode_note#其他问题)

## NO.448 找到所有数组中消失的数字[](2019/12/13/Java_leetcode_note#NO-448-找到所有数组中消失的数字)
...
## NO.1160 拼写单词[](2019/12/13/Java_leetcode_note#NO-1160-拼写单词)
