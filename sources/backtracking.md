...
# 一、方法概述[](2019/10/11/backtracking#一、方法概述)
...
# 二、方法实例[](2019/10/11/backtracking#二、方法实例)

## NO.22 括号生成[](2019/10/11/backtracking#NO-22-括号生成)
...
![](/2019/10/11/backtracking/bt1.jpg)  
...
代码的运行过程如下：  
![](/2019/10/11/backtracking/bt2.jpg)  
...
## NO.39 组合总数[](2019/10/11/backtracking#NO-39-组合总数)
...
代码的运行过程如下：  
![](/2019/10/11/backtracking/bt3.jpg)  
...
## NO.40 组合总数II[](2019/10/11/backtracking#NO-40-组合总数II)
...
## NO.77 列表的组合[](2019/10/11/backtracking#NO-77-列表的组合)
...
问题的解空间如下图所示：  
![](/2019/10/11/backtracking/bt4.jpg)
...
## NO.78 列表的子集[](2019/10/11/backtracking#NO-78-列表的子集)
...
问题的解空间如下图所示：  
![](/2019/10/11/backtracking/bt5.jpg)
...
## N0.90 子集II[](2019/10/11/backtracking#N0-90-子集II)
...
以[1,2,2]为例，解空间的树结构为：  
![](/2019/10/11/backtracking/bt6.jpg)
...
## NO.131 分割回文串[](2019/10/11/backtracking#NO-131-分割回文串)
...
函数的调用过程如下图所指示：  
![](/2019/10/11/backtracking/bt7.jpg)

## NO.216 组合总数III[](2019/10/11/backtracking#NO-216-组合总数III)
...
# 三、另一种解题代码[](2019/10/11/backtracking#三、另一种解题代码)

在Java刷题遇到回溯问题时，看了一下题解，发现了一个新的解题框架，就在这边也记录一下，就拿上面的`NO.39
组合总数`为例，这道题也可以用下面的方法求解：
