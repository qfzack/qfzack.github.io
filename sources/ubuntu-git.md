...
## [](2019/10/11/ubuntu-git#1-git的安装 "1.git的安装")1.git的安装
...
## 2.git版本库[](2019/10/11/ubuntu-git#2-git版本库)
...
## 3.git文件操作[](2019/10/11/ubuntu-git#3-git文件操作)
...
## 4.git远程仓库[](2019/10/11/ubuntu-git#4-git远程仓库)
...
## 5.后续[](2019/10/11/ubuntu-git#5-后续)

后面的教程还包括分支管理和标签管理，是为了便于多人协同工作以及项目的管理，目前还用不上，就只是看了一遍留个印象，估计不久就忘记了。

## 6.使用过程中遇到的问题[](2019/10/11/ubuntu-git#6-使用过程中遇到的问题)
...
[git](/tags/git)[ubuntu](/tags/ubuntu)
