...
Mar 17, 2020[数据库](/categories/%E6%95%B0%E6%8D%AE%E5%BA%93)

# 1.MySQL的安装[](2020/03/17/MySQL_learning#1-MySQL的安装)
...
# 2.MySQL常用命令[](2020/03/17/MySQL_learning#2-MySQL常用命令)
...
# 3.MySQL数据类型[](2020/03/17/MySQL_learning#3-MySQL数据类型)
...
# 4.MySQL基本语法[](2020/03/17/MySQL_learning#4-MySQL基本语法)

### 1.数据库的操作[](2020/03/17/MySQL_learning#1-数据库的操作)
...
### 2.数据表的操作[](2020/03/17/MySQL_learning#2-数据表的操作)
...
### 3.记录的操作[](2020/03/17/MySQL_learning#3-记录的操作)
...
### 4.主键约束[](2020/03/17/MySQL_learning#4-主键约束)
...
### 5.外键约束[](2020/03/17/MySQL_learning#5-外键约束)
...
### 6.唯一约束和非空约束[](2020/03/17/MySQL_learning#6-唯一约束和非空约束)
