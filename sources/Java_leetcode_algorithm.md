...
Nov 6, 2019[Algorithm](/categories/Algorithm)

# 1.求最大公因数-辗转相除法[](2019/11/06/Java_leetcode_algorithm#1-求最大公因数-辗转相除法)
...
# 3.约瑟夫环问题[](2019/11/06/Java_leetcode_algorithm#3-约瑟夫环问题)
...
![](/2019/11/06/Java_leetcode_algorithm/2.png)
...
# 4.卡特兰数Catalan[](2019/11/06/Java_leetcode_algorithm#4-卡特兰数Catalan)

卡特兰数是组合数学中一个经常在各种计数问题中出现的数列，以一个问题为例：使用n个矩形拼成n阶梯形，问拼接的方法有多少种，如下图：

![](/2019/11/06/Java_leetcode_algorithm/catalan.jpg)

n阶梯形包含n个“尖”，每一个“尖”都恰好属于一个矩形，以n=6为例，包含尖角的矩形有以下6种：

![](/2019/11/06/Java_leetcode_algorithm/catalan2.jpg)

如果用 C_n 表示将n阶梯形分解为n个矩形的方法数，则由于每个尖角都可以将梯形分为左右两部分，如下：

![](/2019/11/06/Java_leetcode_algorithm/catalan4.jpg)
...
![](/2019/11/06/Java_leetcode_algorithm/catalan6.jpg)
...
![](/2019/11/06/Java_leetcode_algorithm/catalan8.jpg)

**7.满位置二叉树的计数：**  
有n+1个叶子节点的满位置二叉树(每个节点有0或2个子节点)的种数；  
例如当n=3，有以下5种满位置二叉树：

![](/2019/11/06/Java_leetcode_algorithm/catalan10.jpg)

考虑树的前序遍历：第一次遇到一个非叶子节点，写下一个’(‘，第二次遇到一个非叶子节点，写下一个’)’，从而将问题转换为括号匹配；

![](/2019/11/06/Java_leetcode_algorithm/catalan9.jpg)
