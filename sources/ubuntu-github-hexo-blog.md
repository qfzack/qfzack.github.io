# ubuntu下使用github搭建hexo博客

Oct 11, 2019[Linux](/categories/Linux)

  * 使用github搭建博客应该先安装git和node.js，git已经安装了，现在安装node.js，node.js是运行在服务端的JavaScript（不是很懂）

# 1.安装node.js：[](2019/10/11/ubuntu-github-hexo-blog#1-安装node-js：)
...
# 2\. 安装hexo：[](2019/10/11/ubuntu-github-hexo-blog#2-安装hexo：)
...
# 3\. 部署到github：[](2019/10/11/ubuntu-github-hexo-blog#3-部署到github：)
...
![](/2019/10/11/ubuntu-github-hexo-blog/Image1.jpg)
...
# 4\. 发布文章到博客：[](2019/10/11/ubuntu-github-hexo-blog#4-发布文章到博客：)
...
# 5.安装hexo主题：[](2019/10/11/ubuntu-github-hexo-blog#5-安装hexo主题：)
...
# 6.使用subline Text3编辑文件[](2019/10/11/ubuntu-github-hexo-blog#6-使用subline-
Text3编辑文件)
...
# 7.使用VScode远程连接服务器[](2019/10/11/ubuntu-github-hexo-blog#7-使用VScode远程连接服务器)
...
[github](/tags/github)[hexo](/tags/hexo)[ubuntu](/tags/ubuntu)
