...
Feb 13, 2020[Java](/categories/Java)
...
![](/2020/02/13/Java_Project/1.jpg)  
使用的关于SpringBoot的技术如下图所示：  
![](/2020/02/13/Java_Project/2.jpg)  
使用的一些软件以及版本如下图：  
![](/2020/02/13/Java_Project/3.jpg)  
我并没有完全按照上述的版本进行操作的。

# 1.环境搭配[](2020/02/13/Java_Project#1-环境搭配)

## 1.1 MySQL的安装配置[](2020/02/13/Java_Project#1-1-MySQL的安装配置)
...
## 第五章.买家商品[](2020/02/13/Java_Project#第五章-买家商品)
...
## 第七章.微信授权[](2020/02/13/Java_Project#第七章-微信授权)
