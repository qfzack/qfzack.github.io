...
Apr 24, 2020[数据结构](/categories/%E6%95%B0%E6%8D%AE%E7%BB%93%E6%9E%84)

# 算法比较[](2020/04/24/Sort_Algorithm#算法比较)
...
# 算法实现[](2020/04/24/Sort_Algorithm#算法实现)

## 插入排序[](2020/04/24/Sort_Algorithm#插入排序)

插入排序的基本思想是每一步将一个待排序的数据插入到前面已经排好序的有序序列中，直到插入完所有的元素；  
![](/2020/04/24/Sort_Algorithm/insert.gif)
...
![](/2020/04/24/Sort_Algorithm/bubble2.png)
...
## 归并排序[](2020/04/24/Sort_Algorithm#归并排序)

归并排序(merge-sort)是利用归并思想实现的排序算法，采用分治策略，将问题分成一些小问题进行求解，然后将结果进行合并；

![](/2020/04/24/Sort_Algorithm/merge-sort.png)

每次的合并都是合并两个有序数组：

![](/2020/04/24/Sort_Algorithm/merge.png)
...
## 快速排序[](2020/04/24/Sort_Algorithm#快速排序)
...
![](/2020/04/24/Sort_Algorithm/quicksort.png)
