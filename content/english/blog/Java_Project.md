...
{{< figure src="images/Java_Project/1.jpg" width="50%" height="50%" >}}
使用的关于SpringBoot的技术如下图所示：  
{{< figure src="images/Java_Project/2.jpg" width="50%" height="50%" >}}
使用的一些软件以及版本如下图：
{{< figure src="images/Java_Project/3.jpg" width="50%" height="50%" >}}
我并没有完全按照上述的版本进行操作的。
...
{{< figure src="images/Java_Project/5.jpg" width="50%" height="50%" >}}
